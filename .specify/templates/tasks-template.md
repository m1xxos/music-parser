...
- [ ] T010 Define provider adapters for YouTube, SoundCloud, and RuTube handling boundaries
- [ ] T011 [P] Define async job state model with progress fields and terminal states
- [ ] T012 [P] Validate Docker/Compose runtime path for foundational services
...
- [ ] T021 [US1] Implement/verify trim + metadata edit flow for this story
- [ ] T022 [US1] Implement/verify progress bar UI binding for long-running operations
...
- [ ] TXXX Validate Docker Compose run for final integrated workflow
- [ ] TXXX Verify intuitive defaults and expert controls in the same UI flow
